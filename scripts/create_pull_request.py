...
def create_pr():
    ...
    run_git(['add', 'results/per_model_summary.json'])
    run_git(['add', 'results/per_model_table.csv'])
    run_git(['add', 'results/dynamic_summary.json'])
    run_git(['add', 'results/overconfidence_summary.json'])
    run_git(['add', 'results/taint_review_kappa.json'])
    run_git(['add', 'results/cwe_heatmap.png'])
    run_git(['add', 'results/pillar_agreement_upset.png'])
    run_git(['add', 'results/coverage_violin.png'])
